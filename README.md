...
[![Go Report Card](https://goreportcard.com/badge/go.guillerg.dev/rss-builder)](https://goreportcard.com/report/go.guillerg.dev/rss-builder)
...
Every night, a scheduled Github Actions workflow runs main.go, which builds a RSS xml file and publishes it to [Github Pages](https://guillerg.dev/rss-builder/). I can then use my RSS reader to subscribe to these endpoints.
